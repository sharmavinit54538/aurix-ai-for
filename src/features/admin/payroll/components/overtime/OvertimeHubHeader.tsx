...
interface OvertimeHubHeaderProps {
...
export const OvertimeHubHeader: React.FC<OvertimeHubHeaderProps> = ({
  kpis,
  onCreateClick,
  onBulkApproveClick,
  onExportClick,
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-2xl bg-gradient-to-r from-slate-900/90 via-slate-900/60 to-purple-950/40 border border-white/10 shadow-2xl backdrop-blur-xl">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-2xl font-black text-white tracking-tight">Enterprise Overtime Hub</h1>
                <Badge className="bg-purple-500/20 text-purple-400 border-purple-500/30 text-[10px] uppercase font-bold tracking-wider">
                  Aurix Overtime v2026
                </Badge>
              </div>
              <p className="text-xs text-slate-400">
                Shift Roster Engine, Factories Act Compliance, Biometric Punch Sync, AI Burnout Monitoring & Payroll Disbursal
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          >
            <PlusCircle className="w-4 h-4" /> New OT Request
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 rounded-xl bg-slate-900/60 border border-white/5 space-y-1">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Total OT Hours</span>
            <Clock className="w-4 h-4 text-blue-400" />
          </div>
          <p className="text-2xl font-black text-white font-mono">{kpis.totalOvertimeHours} Hrs</p>
          <p className="text-[11px] text-emerald-400 flex items-center gap-1 font-semibold">
            <TrendingUp className="w-3 h-3" /> 100% Biometric Verified
          </p>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/60 border border-white/5 space-y-1">
          ...
          <p className="text-2xl font-black text-amber-400 font-mono">{kpis.pendingRequests} Claims</p>
          <p className="text-[11px] text-slate-400 font-medium">Awaiting Manager & HR</p>
        </div>

        <div className="p-4 rounded-xl bg-slate-900/60 border border-white/5 space-y-1">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Overtime Payout Value</span>
            <DollarSign className="w-4 h-4 text-emerald-400" />
          </div>
          <p className="text-2xl font-black text-emerald-400 font-mono">{formatCurrency(kpis.totalOvertimeCost)}</p>
          <p className="text-[11px] text-slate-400 font-medium">1.5x, 2.0x & 3.0x Multipliers</p>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/60 border border-white/5 space-y-1">
          ...
          <p className="text-2xl font-black text-purple-400 font-mono">98.8% Compliant</p>
          <p className="text-[11px] text-purple-300 font-medium">Factories Act 1948 Enforced</p>
        </div>
      </div>
    </div>
  );
