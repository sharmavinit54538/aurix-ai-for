...
export const createReview = createAsyncThunk<PerformanceReview, PerformanceReview>(
  ...
  async (review) => {
    await tryApi(() => apiInstance.post("/api/v2/performance/reviews", review), undefined);
    return review;
  },
);
...
export const updateReview = createAsyncThunk<PerformanceReview, PerformanceReview>(
  ...
  async (review) => {
    await tryApi(
      () => apiInstance.put(`/api/v2/performance/reviews/${review.id}`, review),
      undefined,
    );
    return review;
  },
...
export const deleteReview = createAsyncThunk<string, string>(
  ...
  async (id) => {
    await tryApi(() => apiInstance.delete(`/api/v2/performance/reviews/${id}`), undefined);
    return id;
  },
);
...
export const bulkDeleteReviews = createAsyncThunk<string[], string[]>(
  ...
  async (ids) => {
    await tryApi(
      () => apiInstance.post("/api/v2/performance/reviews/bulk-delete", { ids }),
      undefined,
    );
    return ids;
  },
...
>("performance/bulkSetReviewStatus", async (payload) => {
  await tryApi(
    () => apiInstance.post("/api/v2/performance/reviews/bulk-status", payload),
    undefined,
  );
  return payload;
});
...
export const importReviews = createAsyncThunk<PerformanceReview[], PerformanceReview[]>(
  ...
  async (reviews) => {
    await tryApi(
      () => apiInstance.post("/api/v2/performance/reviews/import", { reviews }),
      undefined,
    );
    return reviews;
  },
...
export const createGoal = createAsyncThunk<Goal, Goal>("performance/createGoal", async (goal) => {
  await tryApi(() => apiInstance.post("/api/v2/performance/goals", goal), undefined);
  return goal;
});

export const updateGoal = createAsyncThunk<Goal, Goal>("performance/updateGoal", async (goal) => {
  await tryApi(() => apiInstance.put(`/api/v2/performance/goals/${goal.id}`, goal), undefined);
  return goal;
});

export const deleteGoal = createAsyncThunk<string, string>("performance/deleteGoal", async (id) => {
  await tryApi(() => apiInstance.delete(`/api/v2/performance/goals/${id}`), undefined);
  return id;
});
...
>("performance/assignGoal", async (payload) => {
  ...
  await tryApi(() => apiInstance.post("/api/v2/performance/goals/assign", goal), undefined);
  return goal;
});

export const completeGoal = createAsyncThunk<string, string>(
  "performance/completeGoal",
  async (id) => {
    await tryApi(() => apiInstance.post(`/api/v2/performance/goals/${id}/complete`), undefined);
    return id;
  },
);
...
export const addFeedback = createAsyncThunk<Feedback360, Feedback360>(
  ...
  async (feedback) => {
    await tryApi(() => apiInstance.post("/api/v2/performance/feedback", feedback), undefined);
    return feedback;
  },
);

export const addReward = createAsyncThunk<Reward, Reward>(
  "performance/addReward",
  async (reward) => {
    await tryApi(() => apiInstance.post("/api/v2/performance/rewards", reward), undefined);
    return reward;
  },
);
...
>("performance/assignTraining", async ({ employeeId, courseName }) => {
  ...
  await tryApi(() => apiInstance.post("/api/v2/performance/training/assign", course), undefined);
  return course;
});
...
>("performance/updateTrainingStatus", async ({ id, status }) => {
  await tryApi(
    () => apiInstance.patch(`/api/v2/performance/training/${id}`, { status }),
    undefined,
  );
  return { id, status };
});
