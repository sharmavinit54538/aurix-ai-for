  ...
  return (
    <div className="space-y-6">
      ...
      {dataset.kpis.length > 0 ? (
        ...
        <div className="rounded-2xl border border-dashed border-border/80 bg-card/40 p-8 text-center backdrop-blur-md">
          ...
          <p className="text-xs text-muted-foreground mt-1 max-w-md mx-auto">
            Live {role.toUpperCase()} operational telemetry is not currently configured or backend integration is pending.
          </p>
        </div>
      )}
      ...
      {dataset.charts.length > 0 ? (
        ...
        <div className="rounded-2xl border border-dashed border-border/80 bg-card/40 p-8 text-center backdrop-blur-md">
          <AlertCircle className="mx-auto h-8 w-8 text-muted-foreground/60 mb-2" />
          <h3 className="text-sm font-semibold text-foreground">No telemetry charts available</h3>
          <p className="text-xs text-muted-foreground mt-1 max-w-md mx-auto">
            Historical metric trends and predictive visual models for {role.toUpperCase()} will appear once backend telemetry feeds are connected.
          </p>
        </div>
      )}
