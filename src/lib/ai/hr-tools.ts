...
const DEMO_EMPLOYEES: DemoEmployee[] = [
  { id: "E-1001", name: "Priya Singh",   email: "priya.singh@ofc360.io",   department: "Engineering", role: "Senior Engineer",     manager: "Anita Rao",   joinedOn: "2021-03-14", ctcLpa: 28, performance: 88, attendancePct: 97, unplannedAbsencesMtd: 0, trainingCompletionPct: 100, riskScore: 18, leaveBalance: { casual: 4, sick: 6, earned: 11 } },
  { id: "E-1002", name: "Rahul Mehta",   email: "rahul.mehta@ofc360.io",   department: "Engineering", role: "Engineer II",         manager: "Anita Rao",   joinedOn: "2022-07-01", ctcLpa: 18, performance: 62, attendancePct: 82, unplannedAbsencesMtd: 4, trainingCompletionPct: 40,  riskScore: 71, leaveBalance: { casual: 2, sick: 5, earned: 6 } },
  { id: "E-1003", name: "Anita Rao",     email: "anita.rao@ofc360.io",     department: "Engineering", role: "Engineering Manager", manager: "Vikram Shah", joinedOn: "2019-01-10", ctcLpa: 46, performance: 91, attendancePct: 96, unplannedAbsencesMtd: 1, trainingCompletionPct: 90,  riskScore: 22, leaveBalance: { casual: 5, sick: 7, earned: 14 } },
  { id: "E-1004", name: "Maya Iyer",     email: "maya.iyer@ofc360.io",     department: "Design",      role: "Senior Designer",     manager: "Karan Verma", joinedOn: "2020-11-22", ctcLpa: 24, performance: 84, attendancePct: 94, unplannedAbsencesMtd: 1, trainingCompletionPct: 80,  riskScore: 34, leaveBalance: { casual: 3, sick: 6, earned: 9 } },
  { id: "E-1005", name: "Vikram Shah",   email: "vikram.shah@ofc360.io",   department: "Leadership",  role: "VP Engineering",      manager: "CEO",         joinedOn: "2017-05-02", ctcLpa: 78, performance: 93, attendancePct: 98, unplannedAbsencesMtd: 0, trainingCompletionPct: 100, riskScore: 12, leaveBalance: { casual: 6, sick: 8, earned: 18 } },
  { id: "E-1006", name: "Karan Verma",   email: "karan.verma@ofc360.io",   department: "Design",      role: "Design Lead",         manager: "Vikram Shah", joinedOn: "2019-09-15", ctcLpa: 38, performance: 80, attendancePct: 92, unplannedAbsencesMtd: 2, trainingCompletionPct: 70,  riskScore: 41, leaveBalance: { casual: 4, sick: 6, earned: 10 } },
  { id: "E-1007", name: "Neha Kapoor",   email: "neha.kapoor@ofc360.io",   department: "Sales",       role: "Account Executive",   manager: "Sandeep Roy", joinedOn: "2023-02-01", ctcLpa: 14, performance: 58, attendancePct: 78, unplannedAbsencesMtd: 5, trainingCompletionPct: 25,  riskScore: 82, leaveBalance: { casual: 1, sick: 4, earned: 3 } },
  { id: "E-1008", name: "Sandeep Roy",   email: "sandeep.roy@ofc360.io",   department: "Sales",       role: "Sales Manager",       manager: "Vikram Shah", joinedOn: "2018-04-19", ctcLpa: 42, performance: 76, attendancePct: 88, unplannedAbsencesMtd: 2, trainingCompletionPct: 60,  riskScore: 48, leaveBalance: { casual: 3, sick: 5, earned: 8 } },
];
...
const DEMO_POLICIES = [
  ...
  { id: "POL-POSH-001",  title: "PoSH Policy", section: "5 Complaint Process", content: "Complaints can be raised confidentially via posh@ofc360.io or to any IC member. Inquiry must complete within 90 days under the PoSH Act, 2013." },
