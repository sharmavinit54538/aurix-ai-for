...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The terms that govern your use of OFC360." },
...
const sections = [
  { h: "1. Acceptance of terms", p: "By accessing or using OFC360, you agree to be bound by these Terms & Conditions and our Privacy Policy. If you do not agree, do not use the service." },
  { h: "2. Use of the service", p: "You may use OFC360 only in compliance with these terms and all applicable laws. You are responsible for the activities that occur under your account." },
  ...
  { h: "6. Intellectual property", p: "OFC360 retains all rights in the service. You retain all rights to content you create. You grant us a limited license to host and display your content as needed to provide the service." },
  ...
  { h: "8. Disclaimers", p: "The service is provided \"as is\" without warranties of any kind. To the maximum extent permitted by law, OFC360 disclaims all warranties, express or implied." },
  { h: "9. Limitation of liability", p: "OFC360's liability is limited to the fees you paid in the twelve months prior to the event giving rise to the claim." },
  ...
  { h: "12. Contact", p: "Questions about these terms? Contact legal@ofc360.com." },
];
